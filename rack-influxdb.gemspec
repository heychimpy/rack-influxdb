...
Gem::Specification.new do |s|
  ...
  # influxdb-client requires 'csv', 'base64' and 'logger', which Ruby no
  # longer bundles by default as of 3.4 (csv, base64) and 4.0 (logger);
  # declare them explicitly so consumers on newer Rubies don't hit a
  # LoadError.
